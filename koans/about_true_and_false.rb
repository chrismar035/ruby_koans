...
class AboutTrueAndFalse < EdgeCase::Koan
  ...
  def test_true_is_treated_as_true
    assert_equal :truth_stuff, truth_value(true)
  end
  ...
  def test_everything_else_is_treated_as_true
    assert_equal :truth_stuff, truth_value(1)
    assert_equal :truth_stuff, truth_value(0)
    assert_equal :truth_stuff, truth_value([])
    assert_equal :truth_stuff, truth_value({})
    assert_equal :truth_stuff, truth_value("Strings")
    assert_equal :truth_stuff, truth_value("")
  end
